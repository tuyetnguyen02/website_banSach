<?php
    echo '<header id="tg-header" class="tg-header tg-headervtwo tg-haslayout">
            <div class="tg-topbar">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="tg-userlogin">
                                <figure><a href="javascript:void(0);"><img src="../assets_user/images/users/img-01.jpg" alt="image description"></a></figure>
                                <span>Hi, John</span>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <div class="mega-menu">
                                                ...
                                                <div class="tab-content tg-themetabcontent">
                                                    <div role="tabpanel" class="tab-pane active" id="artandphotography">
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <figure><img src="../assets_user/images/img-01.png" alt="image description"></figure>
                                        ...
                                        <div class="dropdown-menu tg-themedropdownmenu" aria-labelledby="tg-minicart">
                                            <div class="tg-minicartbody">
                                                <div class="tg-minicarproduct">
                                                    <figure>
                                                        <img src="../assets_user/images/products/img-01.jpg" alt="image description">
                                                ...
                                                <div class="tg-minicarproduct">
                                                    <figure>
                                                        <img src="../assets_user/images/products/img-02.jpg" alt="image description">
                                                ...
                                                <div class="tg-minicarproduct">
                                                    <figure>
                                                        <img src="../assets_user/images/products/img-03.jpg" alt="image description">
