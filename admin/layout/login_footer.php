    ...
    echo '<footer id="tg-footer" class="tg-footer tg-haslayout">
                        ...
                        <div class="tg-threecolumns">
                            <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                <div class="tg-footercol">
                                    <strong class="tg-logo"><a href="javascript:void(0);"><img src="../assets_user/images/flogo.png" alt="image description"></a></strong>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                <div class="tg-footercol tg-widget tg-widgettopsellingauthors">
                                    ...
                                    <div class="tg-widgetcontent">
                                        <ul>
                                            <li>
                                                <figure><a href="javascript:void(0);"><img src="../assets_user/images/author/imag-09.jpg" alt="image description"></a></figure>
                                            ...
                                            <li>
                                                <figure><a href="javascript:void(0);"><img src="../assets_user/images/author/imag-10.jpg" alt="image description"></a></figure>
                                                <div class="tg-authornamebooks">
                                            ...
                                            <li>
                                                <figure><a href="javascript:void(0);"><img src="../assets_user/images/author/imag-11.jpg" alt="image description"></a></figure>
                                                <div class="tg-authornamebooks">
            ...
            <div class="tg-footerbar">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <span class="tg-paymenttype"><img src="../assets_user/images/paymenticon.png" alt="image description"></span>
